...
| 002 | MCP bridge | Can those descriptors be re-exposed as an MCP server so an unmodified agent (Claude Code, OpenClaw, Hermes) drives the body with no code of ours in the loop? | 📋 planned | — |
